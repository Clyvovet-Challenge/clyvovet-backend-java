...
| [05-deploy.md](05-deploy.md) | Dockerfile, docker-compose, provisionamento Azure via `deploy.sh` |
| [06-guia-de-desenvolvimento.md](06-guia-de-desenvolvimento.md) | Convenções do código, como adicionar uma entidade nova, build e testes |
