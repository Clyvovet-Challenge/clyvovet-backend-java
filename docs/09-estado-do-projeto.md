...
| | |
|---|---|
| Testes | **277**, cobrindo CRUD, filtros, PATCH, JWT, sessão, ownership, rate limit e migrations |
...
**A base aguenta.** 277 testes, segurança real e schema versionado significam que a
