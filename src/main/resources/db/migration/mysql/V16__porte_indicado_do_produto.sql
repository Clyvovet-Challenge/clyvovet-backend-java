...
-- porte do animal, e o filtro compara os dois lados. Divergir na caixa aqui
-- faria o casamento falhar em silencio no Oracle, que e case-sensitive.
-- ============================================================================

ALTER TABLE t_clyvo_produto
    ADD COLUMN porte_indicado VARCHAR(30) NOT NULL DEFAULT 'TODOS';
