-- ============================================================
-- V2 -- Carga inicial (MySQL)
--
-- O CORPO DESTE ARQUIVO E IDENTICO AO DE oracle/V2__seed_inicial.sql.
-- Sao so INSERTs com literal ANSI (DATE 'aaaa-mm-dd'), aceitos pelos
-- dois bancos -- nao ha nada de especifico aqui.
--
-- Se alterar o seed, altere nos dois. Para conferir que nao divergiram:
--   diff <(tail -n +12 oracle/V2__seed_inicial.sql) <(tail -n +17 mysql/V2__seed_inicial.sql)
--
-- UUIDs fixos em vez de funcao geradora:
--   * o SQL fica portavel (sem PL/SQL);
