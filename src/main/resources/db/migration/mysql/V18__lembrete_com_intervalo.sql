...
--
-- A tabela tinha `recorrente TINYINT`, a API o gravava, o app o oferecia num
...
-- Duas instrucoes, e nao uma com duas clausulas: o H2 em MODE=MySQL nao aceita
-- `ADD COLUMN a, ADD COLUMN b` na mesma ALTER, e e nele que esta migration roda
-- nos testes. O MySQL de verdade aceita as duas formas.
ALTER TABLE t_clyvo_lembrete ADD COLUMN intervalo_dias INT NULL;
ALTER TABLE t_clyvo_lembrete ADD COLUMN repetir_ate DATETIME NULL;
